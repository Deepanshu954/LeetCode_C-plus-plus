<h2><a href="https://leetcode.com/problems/rectangle-overlap">866. Rectangle Overlap</a></h2>
📌 **Complexity Analysis:** [Complexity.md](./Complexity.md)<h3>Easy</h3><hr><p>An axis-aligned rectangle is represented as a list <code>[x1, y1, x2, y2]</code>, where <code>(x1, y1)</code> is the coordinate of its bottom-left corner, and <code>(x2, y2)</code> is the coordinate of its top-right corner. Its top and bottom edges are parallel to the X-axis, and its left and right edges are parallel to the Y-axis.</p>
